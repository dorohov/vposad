...
$('.navbar__collapse a[href="'+url+'"]').parent().addClass('is--active'); 
...
$('.navbar-aside__block').on('shown.bs.dropdown', function () {
	$('body').addClass('is--noscroll');
});
$('.navbar-aside__block').on('hidden.bs.dropdown', function () {
	$('body').removeClass('is--noscroll');
})
$('.navbar-aside__block.dropdown').closest($('body')).addClass('is--navbar-bottom');